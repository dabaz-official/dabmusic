...
const Player = forwardRef<{ startPlay: () => void }, PlayerProps>(({ songs, currentIndex, setCurrentIndex }, ref) => {
  ...
  return (
    <div className="fixed bottom-8 left-4 right-4 bg-neutral-800 border border-black py-2 pl-1 pr-4 shadow-md rounded-full items-center mx-auto w-auto max-w-[64rem]">
      <audio ref={audioRef} />
