    ...
    songs: [
      {
        id: 1,
        title: 'Skrt Freestyle',
        src: '/music/skrt-freestyle/skrt-freestyle.mp3',
        cover: '/music/skrt-freestyle/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/skrt-freestyle/skrt-freestyle.lrc',
      },
    ],
  },
  {
    id: 'slagb-freestyle-2',
    title: 'SLAGB Freestyle 2',
    cover: '/music/slagb-freestyle-2/cover.jpg',
    artist: 'DabAZ',
    isExplicit: true,
    songs: [
      {
        id: 1,
        title: 'SLAGB Freestyle 2',
        src: '/music/slagb-freestyle-2/slagb-freestyle-2.mp3',
        cover: '/music/slagb-freestyle-2/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/slagb-freestyle-2/slagb-freestyle-2.lrc',
      },
    ],
  },
  {
    id: 'dabrockstar',
    title: 'DabRockStar',
    cover: '/music/dabrockstar/cover.jpg',
    artist: 'DabAZ',
    isExplicit: true,
    songs: [
      {
        id: 1,
        title: 'DabRockstar',
        src: '/music/dabrockstar/dabrockstar.mp3',
        cover: '/music/dabrockstar/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/dabrockstar/dabrockstar.lrc',
      },
    ],
  },
  {
    id: 'slagb-freestyle',
    title: 'SLAGB Freestyle',
    cover: '/music/slagb-freestyle/cover.jpg',
    artist: 'DabAZ',
    isExplicit: true,
    songs: [
      {
        id: 1,
        title: 'SLAGB Freestyle',
        src: '/music/slagb-freestyle/slagb-freestyle.mp3',
        cover: '/music/slagb-freestyle/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/slagb-freestyle/slagb-freestyle.lrc',
      },
    ],
  },
  {
    ...
    songs: [
      ...
      },
      {
        id: 3,
        title: '脱离肩膀',
        src: '/music/dracula/off-the-shoulders.mp3',
        cover: '/music/dracula/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/dracula/off-the-shoulders.lrc',
      },
    ],
  },
  {
    id: 'anotherb',
    title: 'AnotherB',
    cover: '/music/anotherb/cover.jpg',
    artist: 'DabAZ',
    isExplicit: true,
    songs: [
      {
        id: 1,
        title: 'AnotherB',
        src: '/music/anotherb/anotherb.mp3',
        cover: '/music/anotherb/cover.jpg',
        artist: 'DabAZ',
        isExplicit: true,
        lyrics: '/music/anotherb/anotherb.lrc',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    songs: [
      ...
      },
      {
        ...
        artist: 'SASIOVERLXRD',
        isExplicit: true,
        lyrics: '/music/na-xiao-zi-zhen-shuai/xia-po.lrc',
      },
    ],
  },
  {
    ...
    songs: [
      {
        ...
        artist: 'SASIOVERLXRD',
        isExplicit: true,
        lyrics: '/music/bo-he-shui/bo-he-shui.lrc',
      },
    ],
  },
];